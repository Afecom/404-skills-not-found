    ...
    return(
        <div>
            <div className="w-[50%] text-center relative top-28 m-auto">
                    ...
                    <h2 className="font-[helvetica] text-2xl font-semibold text-gray-400 mt-1" id="status">{data.current.condition.text}</h2>
                ...
                <div className="relative w-full">
                    <img src={home} loading='lazy' alt="home image" className="mt-36"/>
