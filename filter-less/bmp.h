...
typedef uint8_t  BYTE; // BYTE IS 1 byte unsigned which is positve int;
typedef uint32_t DWORD; // DWORD is 4 byte unsigned which is positive;
typedef int32_t  LONG; // LONG IS 4 BYTES but signed
typedef uint16_t WORD; // WORD is 2 BYTES of unsigned int;
